...
app.post('/fortunes', (req, res) => {
  ...
  const fortune_ids = fortunes.map((fortune) => fortune.id);
...
app.put('/fortunes/:id', (req, res) => {
  ...
  const old_fortune = fortunes.find((fortune) => fortune.id == id);

  ['massage', 'lucky_number', 'spirit_animal'].forEach((key) => {
...
app.delete('/fortunes/:id', (req, res) => {
  ...
  const new_fortunes = fortunes.filter((fortune) => fortune.id != id);
